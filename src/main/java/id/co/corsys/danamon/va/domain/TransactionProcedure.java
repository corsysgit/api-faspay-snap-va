 ...
 * the License.
 ******************************************************************************/
package id.co.corsys.danamon.va.domain;
...
public class TransactionProcedure extends StoredProcedure {
	public TransactionProcedure(JdbcTemplate jdbcTemplate) {
		super(jdbcTemplate, "RET_MOBILE_TRANSACTION");

		declareParameter(new SqlParameter("JENIS_TRANSAKSI", VARCHAR));
		declareParameter(new SqlParameter("ACCOUNT_NUMBER", VARCHAR));
		declareParameter(new SqlParameter("ACCOUNT_NUMBER2", VARCHAR));
		...
		declareParameter(new SqlParameter("VTANGGAL", DATE));
