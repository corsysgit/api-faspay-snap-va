...
import id.co.corsys.danamon.va.domain.InquiryProcedure2;
import id.co.corsys.danamon.va.domain.InquiryProcedure3;
import id.co.corsys.danamon.va.domain.TransactionProcedure;
import id.co.corsys.danamon.va.domain.TransactionProcedure2;
import id.co.corsys.danamon.va.dto.BaseResponse;
import id.co.corsys.danamon.va.dto.CoreInquiryResp;
import id.co.corsys.danamon.va.dto.CorePaymentReq;
import id.co.corsys.danamon.va.dto.CoreVAResp;
import id.co.corsys.danamon.va.helper.CorSysEncoder;
import id.co.corsys.danamon.va.helper.ProductLicense;
